<template>
 <v-container>
  <v-card-text :style="{color:color.p_text}" class="text-center display-2 pa-2 font-weight-black">
  ...
  <v-btn href="/register" light :color="color.accent">
    Get Started Now <v-icon>mdi-arrow-right</v-icon>
  </v-btn>
  </div>
