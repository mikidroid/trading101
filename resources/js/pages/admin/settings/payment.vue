<template>
  ...
  <v-form @submit.prevent="submit">
                  <v-text-field
                    ...
                    outlined
                    dense
                    :error-messages="form.errors.payment_gateway"
                  />
                  <v-text-field
                  ...
                  <v-text-field
                    ...
                    outlined
                    dense
                    :error-messages="form.errors.api_version"
                  />
                  <v-text-field
                    ...
                    outlined
                    dense
                    :error-messages="form.errors.webhook_secret"
                  />
...
export default {
 ...
 methods:{
   submit(){
    this.form.post('/admin/payment-settings/store')
   }
 },
 data(){
    return{
