...
--
-- Host: localhost
-- Generation Time: Jul 29, 2022 at 06:15 PM
...
(9, '2022_07_08_171852_create_investments_table', 1),
(10, '2022_07_09_210029_create_my_transactions_table', 1),
(11, '2022_07_18_065541_create_lotteries_table', 1),
(12, '2022_07_18_114303_create_notifications_table', 1),
(13, '2022_07_18_181027_create_settings_table', 1),
(14, '2022_07_25_010045_create_jobs_table', 1),
(15, '2022_07_25_122045_create_coinbase_webhook_calls_table', 1);

-- --------------------------------------------------------

--
-- Table structure for table `my_transactions`
--
...
CREATE TABLE `my_transactions` (
  ...
  `coin_value` double(8,2) DEFAULT NULL,
  `coin_address` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `settings` (
  ...
  `deposit_min` bigint(20) NOT NULL,
  `deposit_max` bigint(20) NOT NULL,
  `withdrawal_min` bigint(20) NOT NULL,
  `withdrawal_max` bigint(20) NOT NULL,
  `interest_frequency` bigint(20) NOT NULL,
  `interest_percentage` bigint(20) NOT NULL,
  `investment_duration` bigint(20) NOT NULL,
  `investment_min` bigint(20) NOT NULL,
  `investment_max` bigint(20) NOT NULL,
...
--
-- Indexes for table `my_transactions`
--
...
--
-- AUTO_INCREMENT for table `my_transactions`
--
ALTER TABLE `my_transactions`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
